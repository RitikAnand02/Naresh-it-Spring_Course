...
public class DoctorOperationsController {
	...
	*/
	...
	@GetMapping("/report_pagination")//for report page   (G --Get)
	public   String    showReportByPagination(@PageableDefault(page=0,size=3,sort="dname",direction =Direction.ASC)Pageable pageable ,
			                                                                               Map<String,Object> map){
		//use   Service
		Page<DoctorVO>  pageVO=docService.showDoctors(pageable);
		// keep the Page<T> obj in  the shared memory
