...
public class ActorMgmtServiceImpl implements IActorMgmtService {
	...
	@Override
	@CachePut(value = "actorscache1",key = "#vo.aid")
	...
	@Override
	@Cacheable(value = "actorscache1",key = "#id")
	...
	@Override
	@Cacheable(value = "actorscache1",key="#start+'-' +#end")
	...
	@Override
	@CacheEvict(value="actorscache1",key = "#id")
