...
public class ActorOperationsRestController {
	...
	//use  service
		 ActorVO vo1=actorService.registerActor(vo);
		return  new ResponseEntity<String>("Actor is saved with "+vo1.getAid(),HttpStatus.OK);
	}
	...
	public    ResponseEntity<String>  updateActorData(@RequestBody ActorVO vo){
		//use service
		ActorVO vo1=actorService.updateActor(vo);
		//return  ResposeEntity object
	   return new ResponseEntity<String>(vo1.getAid()+"actor is updated",HttpStatus.OK);
	}
