...
//@Component
public class ActorAPI_SaveActorTestRunner implements CommandLineRunner {
	@Autowired
	...
	public void run(String... args) throws Exception {
		//api end point url
		String  url="http://localhost:7799/BootRestProj10-ActorAPI-SwaggerAPI/actor-api/save";
		// prepare json body
		/*	String json_body = "{"
				    + "\"aname\": \"Rajesh Khanna\","
				    + "\"category\": \"Hero\","
		  ...
		  vo.setAname("RGV"); vo.setCategory("director"); vo.setAddrs("hyd");
		  vo.setRemunaration(891000.0);
